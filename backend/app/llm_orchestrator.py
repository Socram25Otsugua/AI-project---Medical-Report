...
from app.prompts import RESPONSE_SYSTEM_PROMPT, REVIEW_SYSTEM_PROMPT
...
from app.schemas import ResponseResult, ReviewResult
...
def review_report(rag: RagDeps, session_id: str, report_text: str) -> Dict[str, Any]:
    ...
    # Tools (MCP) para enriquecer contexto antes do LLM.
